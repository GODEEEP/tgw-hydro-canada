...
def process(output_dir):
  ...
  domain = xr.load_dataset('/vast/projects/godeeep/VIC/params/namerica_domain.nc') # https://zenodo.org/records/5038653
  params = xr.load_dataset('/vast/projects/godeeep/VIC/params/namerica_params.nc') # https://zenodo.org/records/5038653
